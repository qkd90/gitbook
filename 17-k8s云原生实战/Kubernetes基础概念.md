...
echo "192.168.18.17  cluster-endpoint" >> /etc/hosts
...
and service account keys on each node and then running the following as root:
  ...
  kubeadm join cluster-endpoint:6443 --token u10511.z57ogobsyx0d0eku \
    --discovery-token-ca-cert-hash sha256:4d4bc19f5d978d19d51e21ce492e17d72849857a9a19ac026c161dd6556f5acf \
    --control-plane
